...
function createConnectionAPI({
  ...
  const signalChannel = typeof BroadcastChannel !== "undefined" ? new BroadcastChannel(signalChannelName) : null;
  const state = {
    role,
    sharedCode,
    userName,
  ...
  async function handleSignal(message) {
    ...
    try {
      if (message.type === "offer") {
        ...
        sendSignal("answer", { answer: peerConnection.localDescription });
      }
  ...
  async function connect() {
    try {
      ...
      if (state.role === "host") {
        ...
        sendSignal("offer", { offer: peerConnection.localDescription });
      }
      updateState({
...
var createPeerConnectionApi = createConnectionAPI;
export {
  createConnectionAPI,
